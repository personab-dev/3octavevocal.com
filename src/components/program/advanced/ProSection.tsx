...
const artistImages = [
  ...
  { src: "/images/pro-curriculum/artist-3.png", alt: "인피니트 — K-POP 보컬 트레이닝", name: "인피니트", role: "아이돌 그룹" },
  { src: "/images/pro-curriculum/artist-4.png", alt: "하이라이트 — K-POP 보컬 트레이닝", name: "하이라이트", role: "아이돌 그룹" },
  { src: "/images/pro-curriculum/artist-5.png", alt: "신화 — K-POP 보컬 트레이닝", name: "신화", role: "아이돌 그룹" },
